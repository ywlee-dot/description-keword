...
DEFAULT_PROMPT_PATH = os.environ.get("PROMPT_PATH", "prompt.txt")
...
def read_csv_rows_from_path(
    csv_path: str,
    header_range: tuple[str, str] | None = None,
    return_debug: bool = False,
) -> List[Dict[str, Any]] | tuple[List[Dict[str, Any]], Dict[str, Any]]:
    with open(csv_path, "rb") as f:
        return read_csv_rows_from_bytes(f.read(), header_range=header_range, return_debug=return_debug)
